export default function ServicesBar() {
  ...
  return (
    <div className="bg-[#1A1A1A] py-2 overflow-hidden relative mt-[73px] md:mt-[81px]">
          ...
          <div key={i} className="flex items-center">
            {items.map((item, j) => (
              <div key={j} className="flex items-center mx-5">
                <span className="text-white font-['DM_Sans'] font-medium text-[10px] tracking-[0.35em] uppercase">{item}</span>
